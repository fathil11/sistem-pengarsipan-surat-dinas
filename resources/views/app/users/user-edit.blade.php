                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Nama" value="{{ old('name', $user->name) }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="user_position_id" name="user_position_id">
                                    ...
                                    <option value="{{ $position->id }}" {{ old('user_position_id', $user->user_position_id) == $position->id ? 'selected' : '' }}>{{ $position->position }}</option>
                                    @empty
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="user_position_detail_id" name="user_position_detail_id">
                                    @forelse ($position_details as $position_detail)
                                    <option value="{{ $position_detail->id }}" {{ old('user_position_detail_id', $user->user_position_detail_id) == $position_detail->id ? 'selected' : '' }}>{{ $position_detail->position_detail }}</option>
                                    @empty
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="user_department_id" name="user_department_id">
                                    ...
                                    <option value="{{ $department->id }}" {{ old('user_department_id', $user->user_department_id) == $department->id ? 'selected' : '' }}>{{ $department->department }}</option>
                                    @empty
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" placeholder="Kontak WA" value="{{ old('phone_number', $user->phone_number) }}">
                            </div>
                        </div>
                    </div>
