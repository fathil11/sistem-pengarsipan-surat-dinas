                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="user_position_detail_id" name="user_position_detail_id">
                                    ...
                                    <option value="{{ $position_detail->id }}">{{ $position_detail->position_detail }}</option>
                                    @empty
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone_number') is-invalid @enderror" id="phone_number" name="phone_number" placeholder="Kontak WA" value="{{ old('phone_number') }}">
                            </div>
                        </div>
                    </div>
